    ...
    >
      <div class="mx-5 pt-7" v-if="$vuetify.breakpoint.smAndDown">
        <div class="d-flex justify-space-between">
          ...
          <v-btn
            @click="showModal('BasicInformationModal', '900px', '1050px', true)"
            class="mx-2"
            fab
            dark
            small
        ...
        >
          ...
          >
            <span
              ...
              >{{ basicInformation.firstName }}</span
            >
            <span>{{ basicInformation.lastName }}</span>
          </div>
          <div
          ...
          >
            <span
              ...
              >{{ this.user.first_name }} </span
            >
            <span>{{ this.user.family_name }}</span>
          </div>
          ...
          >
            ...
            <span class="text-1f2020">
              {{ basicInformation.universityName }}
            </span>
          </div>
          ...
          >
            ...
            >
            <span class="text-1f2020">
              {{ basicInformation.graduationDate.year }}
              {{ basicInformation.graduationDate.month }}
            </span>
          </div>
          <v-divider class="mt-3"></v-divider>
        </v-col>
...
export default {
  ...
  mounted(){
    ...
    this.basicInformation.firstName = this.user.first_name
     this.basicInformation.lastName = this.user.family_name
     this.basicInformation.universityName = this.user.education_facility.name
     this.basicInformation.graduationDate.year = this.user.graduate_year+'年'
     this.basicInformation.graduationDate.month = this.user.graduate_month+'月'
     this.wordOfAppealDetails = this.user.self_introduction
     this.wordOfAppealDetails = this.user. self_introduction
     this.wordOfAppealDetails = this.user.self_introduction
     this.emailAddressDetails = this.user.email_valid
