...
export default {
      ...
      searchOptions: [
        {
          title: "業界",
          placeholder: "",
          searchParam: "business_industry_ids",
          options: [],
        },
        {
          title: "職種",
          placeholder: "",
          searchParam: "work_category_ids",
          options: [],
        },
        {
          title: "特徴",
          placeholder: "",
          searchParam: "internship_feature_list",
          options: [],
        },
      ],
    };
  ...
  methods: {
    addOptions() {
      this.searchOptions.forEach((optionElement, index) => {
        let options = null;
        if (index === 0) {
        ...
        options.forEach((industry) => {
          let option = {
            title: industry.name,
            id: industry.id,
            checkbox: false,
          };
          optionElement.options.push(option);
        });
      });
    },
    ...
    searchPosts() {
      this.$emit("search-posts", this.searchOptions);
    },
  },
};
</script>
