  ...
  <v-container class="intern-detail-page my-5">
    <v-row>
      <v-col cols="12" md="12">
        ...
        >
          ...
          <div
            class="position-absolute post-counter d-flex align-center justify-center mr-5 mb-3"
          >
            <v-sheet
              v-ripple
              color="transparent"
              class="d-flex align-center justify-center mr-5 fw-400"
            >
              <v-icon
                :size="$vuetify.breakpoint.smAndDown ? '20' : '35px'"
                class="mr-2"
    ...
    <v-row>
        ...
        >
          <div class="d-flex mr-7 company-logo-tag mb-md-auto mb-sm-3 mb-3">
            <span class="company-log-box mr-2 d-flex">
              <img
                :src="
                  getSingleInternship.company && getSingleInternship.company.logo_img
          ...
          <div
            ...
            v-if="getSingleInternship.company && getSingleInternship.company.business_industry"
          >
            <span
      ...
      <v-col cols="12" md="6" class="d-flex mt-md-3 mt-sm-n2 mt-n2">
        <v-card
          class="feature-card-list no-box-shadow px-md-10 px-sm-5 px-5 py-md-9 py-sm-4 py-4 full-width"
        >
          <v-sheet
      ...
      <v-col cols="12" md="6" class="d-flex mt-md-3 mt-sm-n2 mt-n2">
        <v-card
          class="advantages-card-list no-box-shadow px-md-12 px-sm-6 px-6 py-8 full-width"
        >
          <v-sheet
      ...
      <v-col cols="12" md="12" class="mt-md-0 mt-sm-n2 mt-n2">
        <div class="description-txts mt-md-4">
          <h2
            class="desc-heading primary fw-500 mb-md-8 mb-sm-2 mb-2 white--text py-1 px-md-6 px-sm-2 px-2"
            :class="{
              'font-24px': $vuetify.breakpoint.mdAndUp,
              'font-14px': $vuetify.breakpoint.smAndDown,
            }"
      ...
      if (this.user?.id) {
        ...
        this.$store
          ...
          .then((response) => {
            ...
            this.getSingleInternship.favorites_count = responseData.total_counts;
          });
      } else {
        this.$store.commit("showModal", {
